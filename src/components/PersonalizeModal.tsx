...
import { X, Sparkles, Check, Copy, Heart } from 'lucide-react';
          ...
          <form onSubmit={handleSave} className="space-y-4">
            ...
            <div className="pt-2">
              <button
                ...
                className="w-full py-2.5 px-3 bg-amber-50 hover:bg-amber-100/80 text-amber-900 text-xs font-medium rounded-xl border border-amber-200 flex items-center justify-center gap-2 transition-colors"
              >
                {copied ? (
                  <>
            ...
            <div className="flex gap-2 pt-3">
              <button
                type="button"
                onClick={onClose}
                className="flex-1 py-2.5 text-stone-600 hover:bg-stone-100 text-sm font-medium rounded-xl transition-colors"
              >
                Cancel
              </button>
              <button
                ...
                className="flex-1 py-2.5 bg-gradient-to-r from-pink-500 to-rose-500 hover:from-pink-600 hover:to-rose-600 text-white text-sm font-semibold rounded-xl shadow-md transition-transform active:scale-95"
              >
                Apply Changes
              </button>
            </div>
